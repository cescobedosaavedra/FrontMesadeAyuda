<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Login.aspx.vb" Inherits="mesadeayudamvnet.Login" %>
        ...
        <div id="abrigo_general" align="center">
            ...
            <div id="login">
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="2" align="left">
                            <asp:TextBox ID="txtPassword" runat="server" Width="178px" ></asp:TextBox></td>
                    </tr>
