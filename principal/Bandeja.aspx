<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Bandeja.aspx.cs" Inherits="principal.Bandeja" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <table width="950px" style="border: 1px double #666666; border-radius: 6px; -webkit-box-shadow: 10 1px 2px #ff0000; font-family: Verdana, Geneva, Tahoma, sans-serif; font-size: 11px; color: #3C3C3C; background-color: #FFFFFF;">
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="btn_listar" runat="server" Text="Listar" Height="26px" Width="126px" OnClick="btn_listar_Click" /></td>
        </tr>
        <tr>
            <td></td>
            <td></td>
    ...
    <div>
    <table width="950px" height="300px" style="border: 1px double #666666; border-radius: 6px; -webkit-box-shadow: 10 1px 2px #ff0000; font-family: Verdana, Geneva, Tahoma, sans-serif; font-size: 11px; color: #3C3C3C; background-color: #FFFFFF;" id="table_dv">
        <tr>
